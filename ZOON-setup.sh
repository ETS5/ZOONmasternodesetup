...
To introduce your new masternode to the ZOON network, you need to
...
Currently your masternode is syncing with the ZOON network...
...
========================================================================
Enjoy your ZOON Masternode and thanks for using this setup script!
